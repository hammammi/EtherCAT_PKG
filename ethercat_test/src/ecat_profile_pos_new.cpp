...
//ver 1
int gear_ratio[NUMOFEPOS4_DRIVE] = {160, 160, 160, 120, 100, 100, 100};
//double g_AxisVelRatio[] = {1.6, 1.6, 1.6, 1.2, 1, 1, 1};
int pulse_rev[NUMOFEPOS4_DRIVE] = {4096, 4096, 4096, 4096, 2048, 2048, 2048};
    ...
    while (run)
    {
        ...
        else
        {
            for (i=0; i<NUMOFEPOS4_DRIVE; i++)
            {
                ...
                c_1[i] = velprofile[i]*velprofile[i]/2.0/accprofile[i]*resol[i]/60.0;
