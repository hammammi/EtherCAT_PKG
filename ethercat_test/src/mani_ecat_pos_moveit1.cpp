...
int pos_desired[NUMOFEPOS4_DRIVE] = {0};
double pos_desired_rad[NUMOFEPOS4_DRIVE] = {0};
...
void motion_callback(const ethercat_test::trajectory::ConstPtr& msg)
{

//    std::vector<trajectory_msgs::JointTrejectoryPoint>::size_type traj = msg->goal.trajectory.points.size();
